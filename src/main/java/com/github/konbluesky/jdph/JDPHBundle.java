...
public final class JDPHBundle extends DynamicBundle {

    @NonNls
    private static final String BUNDLE = "messages.jdph";

    private static final JDPHBundle INSTANCE = new JDPHBundle();
